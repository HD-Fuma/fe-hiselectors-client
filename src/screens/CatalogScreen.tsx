...
const catalogMeta: Record<Exclude<ScreenId, 'catalog'>, { label: string; description: string; group: string }> = {
  ...
  'owner-shop-group': { label: '상품 그룹 상세', description: '셀렉터가 관리하는 상품 그룹 상세', group: '셀렉터스샵' },
  'shop-groups': { label: '상품 그룹 관리', description: '셀렉터스샵에 노출할 상품 묶음 관리', group: '셀렉터스샵' },
  'group-create': { label: '상품 그룹 만들기', description: '새 상품 그룹에 담을 상품 선택', group: '셀렉터스샵' },
  'group-edit': { label: '상품 그룹 편집', description: '기존 상품 그룹의 이름과 상품 변경', group: '셀렉터스샵' },
  'group-campaign-create': { label: '캠페인 상품 그룹 만들기', description: '캠페인에서 시작하는 상품 그룹 생성', group: '셀렉터스샵' },
